  ...
  if (option?.legs) {
    ...
    option.legs.forEach((leg, li) => {
      ...
      if (points.length >= 2) {
        ...
        // For MRT legs, async-replace with real OSM track geometry so lines
        // follow actual rail curves rather than straight station-to-station segments.
        if (leg.type === "mrt") {
          const map = _planMap;
      ...
      // Draw a short dashed connector if this transit leg and the next start/end at different points
